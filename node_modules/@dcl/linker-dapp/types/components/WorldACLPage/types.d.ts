...
export declare type MapStateProps = Pick<Props, 'wallet' | 'isConnected' | 'isConnecting' | 'signed' | 'isSigning' | 'info'>;
export declare type MapDispatchProps = Pick<Props, 'onConnectWallet' | 'onSignContent' | 'onFetchInfo'>;
