...
export declare type MapStateProps = Pick<Props, 'wallet' | 'isConnected' | 'isConnecting' | 'signed' | 'isUpdateAuthorized' | 'authorizations' | 'isAuthorizationLoading' | 'isSigning' | 'info'>;
