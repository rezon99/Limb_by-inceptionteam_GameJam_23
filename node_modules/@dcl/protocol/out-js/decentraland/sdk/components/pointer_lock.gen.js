...
(function (PBPointerLock) {
    ...
    PBPointerLock.fromJSON = fromJSON;
    function toJSON(message) {
        const obj = {};
        message.isPointerLocked !== undefined && (obj.isPointerLocked = message.isPointerLocked);
        return obj;
    }
    PBPointerLock.toJSON = toJSON;
    function create(base) {
        return PBPointerLock.fromPartial(base !== null && base !== void 0 ? base : {});
    }
    PBPointerLock.create = create;
    ...
    PBPointerLock.fromPartial = fromPartial;
