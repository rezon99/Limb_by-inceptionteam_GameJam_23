...
export declare namespace RealmInfo {
    function encode(message: RealmInfo, writer?: _m0.Writer): _m0.Writer;
    function decode(input: _m0.Reader | Uint8Array, length?: number): RealmInfo;
    function fromJSON(object: any): RealmInfo;
    function toJSON(message: RealmInfo): unknown;
    function create<I extends Exact<DeepPartial<RealmInfo>, I>>(base?: I): RealmInfo;
    function fromPartial<I extends Exact<DeepPartial<RealmInfo>, I>>(object: I): RealmInfo;
}
