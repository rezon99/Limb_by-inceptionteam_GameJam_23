...
export namespace PBUiInputResult {
  export function encode(message: PBUiInputResult, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.value !== "") {
  ...
  export function create<I extends Exact<DeepPartial<PBUiInputResult>, I>>(base?: I): PBUiInputResult {
    return PBUiInputResult.fromPartial(base ?? {});
  }
