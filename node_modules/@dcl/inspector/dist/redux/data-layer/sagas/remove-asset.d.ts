import { ErrorType, IDataLayer, removeAsset } from '..';
import { Empty } from '../../../lib/data-layer/remote-data-layer';
export declare function removeAssetSaga(action: ReturnType<typeof removeAsset>): Generator<import("redux-saga/effects").PutEffect<{
    payload: {
        error: ErrorType;
    };
