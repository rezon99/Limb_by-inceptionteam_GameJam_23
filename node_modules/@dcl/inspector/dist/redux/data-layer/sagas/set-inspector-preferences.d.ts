import { ErrorType, IDataLayer, setInspectorPreferences } from '..';
import { InspectorPreferences } from '../../../lib/logic/preferences/types';
export declare function setInspectorPreferencesSaga(action: ReturnType<typeof setInspectorPreferences>): Generator<import("redux-saga/effects").SelectEffect | import("redux-saga/effects").PutEffect<{
    payload: {
        error: ErrorType;
    };
    type: "data-layer/error";
}> | import("redux-saga/effects").CallEffect<IDataLayer> | import("redux-saga/effects").CallEffect<import("../../../tooling-entrypoint").Empty> | import("redux-saga/effects").PutEffect<{
    payload: {
        preferences: InspectorPreferences;
    };
    type: "app-state/updatePreferences";
}>, void, (InspectorPreferences & Readonly<import("@dcl/rpc/dist/codegen-types").RawClient<import("@dcl/rpc/dist/codegen-types").FromTsProtoServiceDefinition<{
...
}>, import("../../../tooling-entrypoint").DataLayerContext>>) | undefined>;
