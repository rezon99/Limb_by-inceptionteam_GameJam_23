...
export declare function getAssetCatalogSaga(): Generator<import("redux-saga/effects").PutEffect<{
    payload: {
        error: ErrorType;
    };
    type: "data-layer/error";
}> | import("redux-saga/effects").CallEffect<IDataLayer> | import("redux-saga/effects").CallEffect<AssetCatalogResponse> | import("redux-saga/effects").PutEffect<{
    payload: {
        assets: AssetCatalogResponse;
    };
    type: "app-state/updateAssetCatalog";
...
}>, import("../../../lib/data-layer/types").DataLayerContext>> & AssetCatalogResponse>;
