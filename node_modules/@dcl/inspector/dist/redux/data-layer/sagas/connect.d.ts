...
export declare function getWsUrl(): string | null;
...
export declare function connectSaga(): Generator<import("redux-saga/effects").CallEffect<string | null> | import("redux-saga/effects").CallEffect<import("@dcl/rpc/dist/codegen-types").RawClient<import("@dcl/rpc/dist/codegen-types").FromTsProtoServiceDefinition<{
...
}>, void, (string | undefined) & IDataLayer & WebSocket & EventChannel<WsActions> & WsActions & Pick<import("mitt").Emitter<import("@dcl/rpc").TransportEvents>, "on" | "emit"> & {
